...
#
#
# for lambda_ in (1, .1, .01):
#     print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=lambda_))
#
#
# #######################################################################
...
# t=2, err=0.1261
# for t in .5, 1.0, 2.0:
#     print(f'{t=}, {run_softmax_on_MNIST(t)=}')
...
# theta, cost_hist = softmax_regression(train_pca, train_y, temp_parameter=1,
#                                       alpha=0.3, lambda_factor=1e-4, k=10,
#                                       num_iterations=150)
# err = compute_test_error(test_pca, test_y, theta, temp_parameter=1)

# err: 0.1483
# print(f'Softmax regression accuracy after reduction to PC: {err}')
...
theta, cost_hist = softmax_regression(train_cube, train_y, temp_parameter=1,
                                      alpha=0.3, lambda_factor=1e-4, k=10,
                                      num_iterations=150)
err = compute_test_error(test_cube, test_y, theta, temp_parameter=1)
# err: 0.08
print(f'Err: {err}')
